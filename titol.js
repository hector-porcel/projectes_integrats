...
function dibuixarTitol() {
    botons = [
        ...
        { x:width/2-150, y:height/2, w: 120, h: 50, text: idioma[a][1], c: color(255, 180, 100) },
        { x:width / 2+90, y:height/2, w: 100, h: 50, text: idioma[a][2], c: color(150, 255, 150) },
        {x:width /2-100, y: 20, w: 240, h: 50, text:idioma[a] [3],c:color(210,210,240) }
      ];
